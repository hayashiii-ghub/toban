...
**Submission status (2026-09-03):** submitted to [The WebMCP Challenge on Devpost](https://devpost.com/software/toban). The app is live at [toban.app](https://toban.app/), the source is public at [github.com/hayashiii-ghub/toban-app](https://github.com/hayashiii-ghub/toban-app), and the final 2:00 master has passed technical and editorial QA. **Demo video:** [https://youtu.be/4CSxh6WW51w](https://youtu.be/4CSxh6WW51w).
